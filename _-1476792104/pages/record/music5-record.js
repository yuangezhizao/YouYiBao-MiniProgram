    ...
    function t() {
        ...
        n.config = {
            ...
            recordDetail: function(e) {
                wx.navigateTo({
                    url: "/pages/record/music5-detail?machineId=" + e.machineId + "&scoreId=" + e.scoreId
                });
            }
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(music5Record, "pages/record/music5-record"));