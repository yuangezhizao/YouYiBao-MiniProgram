!function() {
            ...
            value: (l = o(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 3:
                        1 == (r = e.sent).code && (this.scoreDetail = r.data, this.getMusicHiscore5(r), 
                        this.$apply());
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        }, e.next = 3, a.default.hiscoreMusic5(r);
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(u, "pages/record/music5-detail"));
}();