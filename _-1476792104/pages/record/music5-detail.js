...
var _createClass = function() {
    ...
    function t() {
        ...
        n.config = {
            ...
            rank: function() {
                wx.navigateTo({
                    url: "/pages/record/music5-rank?musicId=" + this.scoreDetail.musicId + "&musicGrade=" + this.scoreDetail.musicGrade
                });
            },
            statisRecord: function() {
                wx.navigateTo({
                    url: "/pages/record/music5-statis?productId=" + this.scoreDetail.productId
                });
            },
            track: function() {
                wx.navigateTo({
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 3:
                        r = e.sent, 1 == r.code && (this.scoreDetail = r.data, this.getMusicHiscore5(r), 
                        this.$apply());
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        }, e.next = 3, _konamiApi2.default.hiscoreMusic5(r);
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(music5Detail, "pages/record/music5-detail"));