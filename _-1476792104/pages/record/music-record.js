    ...
    function t() {
        ...
        n.config = {
            ...
            recordDetail: function(e) {
                wx.navigateTo({
                    url: "/pages/record/music-detail?machineId=" + e.machineId + "&scoreId=" + e.scoreId
                });
            }
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(musicRecord, "pages/record/music-record"));