!function() {
        ...
        function o() {
            ...
            n.config = {
                ...
                statisRecord: function() {
                    wx.navigateTo({
                        url: "/pages/record/pong-statis?productId=" + this.scoreDetail.productId
                    });
                },
                rank: function() {
                    wx.navigateTo({
                        url: "/pages/record/pong-rank?productId=" + this.scoreDetail.productId
                    });
                }
            }, s(n, t);
        }
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(c, "pages/record/pong-detail"));
}();