...
var _createClass = function() {
    ...
    function t() {
        ...
        r.config = {
            ...
            currentTab: 0,
            navbar: [ "简单难度(NOV)", "一般难度(ADV)", "困难难度(EXH)" ],
            rankList: [],
            musicId: 0,
            rankInfo: "",
            top3: [],
            ...
            navbarTap: function(e) {
                ...
                this.pageNo = 1, this.canLoadMore = !0, this.getMusicRank());
            }
    ...
    return _inherits(t, e), _createClass(t, [ {
        key: "onLoad",
        value: function(e) {
            this.musicId = e.musicId, this.currentTab = e.musicGrade, this.getMusicRank();
        }
    }, {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        }, e.next = 3, _konamiApi2.default.rankMusic(t);
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(musicRank, "pages/record/music-rank"));