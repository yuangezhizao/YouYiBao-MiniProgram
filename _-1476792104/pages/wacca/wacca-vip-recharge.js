!function() {
    ...
    }(), t = s(require("./../../npm/wepy/lib/wepy.js")), n = s(require("./../../utils/wacca-api.js")), r = s(require("./../../mixins/user-mixin.js")), i = s(require("./../../utils/units.js")), a = s(require("./../../utils/wechat.js")), o = s(require("./../../components/match-statusbar.js")), c = s(require("./../../components/custom-dialog.js"));
    function s(e) {
    ...
    var f = function(t) {
        function s() {
            ...
            return t = n = p(this, (e = s.__proto__ || Object.getPrototypeOf(s)).call.apply(e, [ this ].concat(u))), 
            n.config = {
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(f, "pages/wacca/wacca-vip-recharge"));
}();