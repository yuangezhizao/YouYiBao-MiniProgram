!function() {
    ...
    }(), t = s(require("./../../npm/wepy/lib/wepy.js")), r = s(require("./../../components/custom-statusbar.js")), n = s(require("./../../utils/api.js")), a = s(require("./../../utils/wacca-api.js")), o = s(require("./../../components/match-dialog.js")), c = s(require("./../../components/custom-progress.js")), i = s(require("./../../utils/wechat.js"));
    function s(e) {
    ...
    var f = function(t) {
        function s() {
            ...
            return t = n = l(this, (e = s.__proto__ || Object.getPrototypeOf(s)).call.apply(e, [ this ].concat(i))), 
            n.config = {
                ...
                toTrophy: function() {
                    wx.navigateTo({
                        url: "/pages/wacca/wacca-trophy?type=1"
                    });
                },
                ...
                toPrivilege: function() {
                    wx.navigateTo({
                        url: "/pages/wacca/wacca-vip-rights?type=1"
                    });
                },
                toCodePage: function() {
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(f, "pages/wacca/wacca-statis"));
}();