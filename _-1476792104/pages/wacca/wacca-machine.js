!function() {
    ...
    }(), t = l(require("./../../npm/wepy/lib/wepy.js")), a = l(require("./../../components/custom-statusbar.js")), n = l(require("./../../utils/wacca-api.js")), r = l(require("./../../components/custom-dialog.js")), i = l(require("./../../components/match-dialog.js")), o = l(require("./../../utils/api.js")), s = l(require("./../../utils/wechat.js")), c = l(require("./../../utils/environment.js")), u = l(require("./../../components/custom-progress.js"));
    function l(e) {
    ...
    var m = function(t) {
        function l() {
            ...
            return t = n = f(this, (e = l.__proto__ || Object.getPrototypeOf(l)).call.apply(e, [ this ].concat(s))), 
            n.config = {
        ...
        return function(e, t) {
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            serialNo: this.serialNo,
                            tag: this.tag
                        }, e.next = 3, n.default.startPlayWacca(t);
            ...
            value: (m = p(regeneratorRuntime.mark(function e(t) {
                var a, n, r, i, u;
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(m, "pages/wacca/wacca-machine"));
}();