!function() {
    ...
    var l = function(t) {
        ...
        return function(e, t) {
            ...
            key: "onLoad",
            value: function(e) {
                this.type = parseInt(e.type), console.log("=============" + this.type), this.type;
            }
        }, {
            key: "onShow",
            value: function() {
            ...
            value: (f = i(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 3:
                        1 == (t = e.sent).code && (this.memberInfo = t.data, this.$apply()), e.next = 11;
                        break;
                      ...
                      case 9:
                        1 == (n = e.sent).code && (this.memberInfo = n.data, this.$apply());
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return e.next = 3, o.default.goodsList();
                      ...
                      case 7:
                        return e.next = 9, o.default.goodsListWacca2();

                      case 9:
                        if (1 == (r = e.sent).code) {
                            for (this.goodsList = r.data, a = 0; a <= this.goodsList.length - 1; a++) this.count[a] = 1;
                            this.$apply();
                        }
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(l, "pages/wacca/wacca-shop"));
}();