!function() {
            ...
            value: (v = h(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, i.default.getMemberInfoDance();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return t = {
                            ...
                            tag: this.tag
                        }, e.next = 4, i.default.scanCodeDance(t);
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        }, e.next = 3, i.default.trialMemberDance(t);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            ...
                            serialNo: this.serialNo,
                            tag: this.tag
                        }, e.next = 3, i.default.startPlayDance(t);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return r = {
                            membershipType: t,
                            exchangeType: n
                        }, e.next = 3, i.default.preExchangeMemberDance(r);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return r = {
                            ...
                            membershipType: t,
                            exchangeType: n
                        }, e.next = 3, i.default.exchangeMemberDance(r);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            membershipType: 4,
                            exchangeType: 2
                        }, console.log("1111111111111111" + JSON.stringify(t)), e.next = 4, i.default.preExchangeMemberDance(t);
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(m, "pages/machine/machine-dance"));
}();