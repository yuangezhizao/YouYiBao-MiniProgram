...
}(), _wepy = require("./../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _matchStatusbar = require("./../../components/match-statusbar.js"), _matchStatusbar2 = _interopRequireDefault(_matchStatusbar), _api = require("./../../utils/api.js"), _api2 = _interopRequireDefault(_api), _userMixin = require("./../../mixins/user-mixin.js"), _userMixin2 = _interopRequireDefault(_userMixin), _konamiApi = require("./../../utils/konami-api.js"), _konamiApi2 = _interopRequireDefault(_konamiApi), _customDialog = require("./../../components/custom-dialog.js"), _customDialog2 = _interopRequireDefault(_customDialog), _wechat = require("./../../utils/wechat.js"), _wechat2 = _interopRequireDefault(_wechat), _environment = require("./../../utils/environment.js"), _environment2 = _interopRequireDefault(_environment), machineMusic5 = function(e) {
    function t() {
        var e, n, r, i;
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, _konamiApi2.default.getMemberInfoMusic5();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return t = {
                            ...
                            tag: this.tag
                        }, e.next = 4, _konamiApi2.default.scanCodeMusic5(t);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            ...
                            serialNo: this.serialNo,
                            tag: this.tag
                        }, e.next = 3, _konamiApi2.default.startPlayMusic5(t);
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(machineMusic5, "pages/machine/machine-music5"));