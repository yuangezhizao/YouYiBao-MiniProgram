!function() {
        ...
        return function(e, t) {
            ...
            value: (v = h(regeneratorRuntime.mark(function e() {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.next = 2, i.default.getMemberInfoMusic();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return t = {
                            ...
                            tag: this.tag
                        }, e.next = 4, i.default.scanCodeMusic(t);
            ...
            key: "startGame",
            value: (y = h(regeneratorRuntime.mark(function e() {
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            ...
                            serialNo: this.serialNo,
                            tag: this.tag
                        }, e.next = 3, i.default.startPlayMusic(t);
            ...
            key: "exchangeMember",
            value: (g = h(regeneratorRuntime.mark(function e(t, n) {
                var r, a;
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
    ...
    Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(m, "pages/machine/machine-music"));
}();