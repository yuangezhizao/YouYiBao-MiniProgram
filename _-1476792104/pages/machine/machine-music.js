...
var _createClass = function() {
...
}(), _wepy = require("./../../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _matchStatusbar = require("./../../components/match-statusbar.js"), _matchStatusbar2 = _interopRequireDefault(_matchStatusbar), _api = require("./../../utils/api.js"), _api2 = _interopRequireDefault(_api), _userMixin = require("./../../mixins/user-mixin.js"), _userMixin2 = _interopRequireDefault(_userMixin), _konamiApi = require("./../../utils/konami-api.js"), _konamiApi2 = _interopRequireDefault(_konamiApi), _customDialog = require("./../../components/custom-dialog.js"), _customDialog2 = _interopRequireDefault(_customDialog), _wechat = require("./../../utils/wechat.js"), _wechat2 = _interopRequireDefault(_wechat), _environment = require("./../../utils/environment.js"), _environment2 = _interopRequireDefault(_environment), machineMusic = function(e) {
    function t() {
        var e, n, r, i;
    ...
    return _inherits(t, e), _createClass(t, [ {
        ...
        value: function() {
            ...
            0 == this.isScan && this.getMemberState(), e || 0 == this.isScan ? this.scanCodeMusic() : (this.scanTxt = "二维码已过期，请重新扫码", 
            this.showScan = !0);
        }
    }, {
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        return t = {
                            ...
                            tag: this.tag
                        }, e.next = 4, _konamiApi2.default.scanCodeMusic(t);
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        ...
                        }, e.next = 3, _konamiApi2.default.trialMemberMusic(t);
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return t = {
                            ...
                            serialNo: this.serialNo,
                            tag: this.tag
                        }, e.next = 3, _konamiApi2.default.startPlayMusic(t);
                      ...
                      case 3:
                        ...
                        this.showAlert = !0) : (wx.showToast({
                            ...
                            url: "/pages/record/music-statis?productId=" + this.machineDetail.productId + "&productName=" + this.machineDetail.productName + "&productImage=" + this.machineDetail.image
                        })), this.$apply();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return r = {
                            membershipType: t,
                            exchangeType: n
                        }, e.next = 3, _konamiApi2.default.preExchangeMemberMusic(r);

                      case 3:
                        i = e.sent, i && (1 !== i.code ? (this.alertTxt = i.message, this.showAlert = !0) : (this.consumePoint = i.data.consumePoint, 
                        this.exchangeDays = i.data.validDays, this.showExc = !0)), this.$apply();
                    ...
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return r = {
                            ...
                            membershipType: t,
                            exchangeType: n
                        }, e.next = 3, _konamiApi2.default.exchangeMemberMusic(r);

                      case 3:
                        i = e.sent, i && (1 !== i.code ? (this.alertTxt = i.message, this.showAlert = !0) : (this.showExc = !1, 
                        this.getMemberState())), this.$apply();
            ...
            var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                ...
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      ...
                      case 2:
                        return n = e.sent, r = n.code, i = _environment2.default.production ? _environment2.default.prod.appid : _environment2.default.dev.appid, 
                        a = {
                            appid: i,
                            code: r,
                            templateIds: t
                        }, console.log("参数", a), e.next = 9, _api2.default.subscribeTemplate(a);
...
Page(require("./../../npm/wepy/lib/wepy.js").default.$createPage(machineMusic, "pages/machine/machine-music"));